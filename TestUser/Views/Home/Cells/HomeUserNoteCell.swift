...
class HomeUserNoteCell: UITableViewCell {
    ...
    private var noteImageView: UIImageView = {
       let iv = UIImageView()
        iv.translatesAutoresizingMaskIntoConstraints = false
        let img = ImageHelper.createSystemImage("doc")
        iv.image = img
...
extension HomeUserNoteCell {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            labelStackView.trailingAnchor.constraint(equalTo: noteImageView.leadingAnchor, constant: -10),
            labelStackView.centerYAnchor.constraint(equalTo: userImageView.centerYAnchor),
            
            noteImageView.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -10),
...
extension HomeUserNoteCell: ConfigurableCell {
